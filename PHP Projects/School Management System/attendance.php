                            ...
                            <div class="panel-heading">
                                ...
                                <div class="pull-right">
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#attendanceFormModal">Add Attendance</button>
...
$total_query = "SELECT COUNT(*) FROM attendance";
$total_result = mysqli_query($con, $total_query);
$total_records = mysqli_fetch_array($total_result)[0];
$total_pages = ceil($total_records / $limit);

// Fetch the required records for the current page
$slc = "SELECT a.attendance_id, s.student_name, c.class_name, a.date, a.status 
        FROM attendance a 
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td class='table-actions'><a href='attendance/editing.php?attendance_id=" . $attendance_id . "' class='edit btn btn-primary'>Edit</a></td>";
                        echo "<td class='table-actions'><a href='attendance/delete.php?attendance_id=" . $attendance_id . "' class='edit btn btn-danger'>Delete</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </table>
                ...
                <div class="pagination">
                    ...
                    if ($total_pages > 1) {
                        ...
                        // Previous button
                        if ($page > 1) {
                            echo '<li class="page-item"><a class="page-link" href="attendance.php?page=' . ($page - 1) . '">Previous</a></li>';
                        }

                        // Page numbers
                        for ($i = 1; $i <= $total_pages; $i++) {
                            if ($i == $page) {
                                echo '<li class="page-item active"><a class="page-link" href="attendance.php?page=' . $i . '">' . $i . '</a></li>';
                            } else {
                                echo '<li class="page-item"><a class="page-link" href="attendance.php?page=' . $i . '">' . $i . '</a></li>';
                            }
                        }

                        // Next button
                        if ($page < $total_pages) {
                            echo '<li class="page-item"><a class="page-link" href="attendance.php?page=' . ($page + 1) . '">Next</a></li>';
                        }
                    ...
                    <div class="modal fade" id="attendanceFormModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="attendanceFormModalLabel">Attendance Form</h4>
                                </div>
                                <div class="modal-body">
                                    <form role="form" action="attendance.php"  method ="POST">
