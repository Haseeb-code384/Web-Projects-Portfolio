...
if (isset($_POST['student_id'])) {
    ...
    $class_id = $_POST['class_id']; // Capture class_id from the form
    $amount = $_POST['amount'];
    $due_date = $_POST['due_date'];
    $status = $_POST['status'];

    $sql = "INSERT INTO `fees` (`student_id`, `class_id`, `amount`, `due_date`, `status`) VALUES ('$student_id', '$class_id', '$amount', '$due_date', '$status');";
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-primary">
                        ...
                        data-target="#feeFormModal">Add Fee</button>
...
$total_query = "SELECT COUNT(*) FROM fees";
$total_result = mysqli_query($con, $total_query);
$total_records = mysqli_fetch_array($total_result)[0];
$total_pages = ceil($total_records / $limit);

// Fetch the required records for the current page
$slc = "SELECT f.fee_id, s.student_name, c.class_name, f.amount, f.due_date, f.status 
        FROM fees f
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td class='table-actions'><a href='fees/edit.php?fee_id=" . $fee_id . "' class='edit btn btn-primary'>Edit</a></td>";
                        echo "<td class='table-actions'><a href='fees/deleted.php?fee_id=" . $fee_id . "' class='edit btn btn-danger'>Delete</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </table>
                ...
                <div class="pagination">
                    ...
                    if ($total_pages > 1) {
                        ...
                        // Previous button
                        if ($page > 1) {
                            echo '<li class="page-item"><a class="page-link" href="fees.php?page=' . ($page - 1) . '">Previous</a></li>';
                        }

                        // Page numbers
                        for ($i = 1; $i <= $total_pages; $i++) {
                            if ($i == $page) {
                                echo '<li class="page-item active"><a class="page-link" href="fees.php?page=' . $i . '">' . $i . '</a></li>';
                            } else {
                                echo '<li class="page-item"><a class="page-link" href="fees.php?page=' . $i . '">' . $i . '</a></li>';
                            }
                        }

                        // Next button
                        if ($page < $total_pages) {
                            echo '<li class="page-item"><a class="page-link" href="fees.php?page=' . ($page + 1) . '">Next</a></li>';
                        }
                    ...
                    <div class="modal fade" id="feeFormModal" tabindex="-1" role="dialog"
                        aria-labelledby="feeFormModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                            aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title" id="feeFormModalLabel">Fee Form</h4>
                                </div>
                                <div class="modal-body">
                                    <form role="form" action="fees.php" method="POST">
