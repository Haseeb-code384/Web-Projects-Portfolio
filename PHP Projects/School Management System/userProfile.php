        ...
        <div id="page-wrapper">
              ...
              <div class="col-lg-9">
                <div class="panel panel-primary">
                  <div class="panel-body">
                    ...
                    <h4>Contact Info</h4>
                    <ul>
                      <li><i class="fa fa-envelope fa-fw"></i> contact@sourcecodepk.com</li>
                      <li><i class="fa fa-phone fa-fw"></i> +92 314 0479594</li>
                      <li><i class="fa fa-facebook fa-fw"></i> Source Code-Smc Pvt Limited</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    <i class="fa fa-bell fa-fw"></i>Activity Feed
                  </div>
                  <div class="panel-body">
                    <ul class="list-group">
                      <li class="list-group-item">
                        <i class="fa fa-comment fa-fw"></i> Commented on a post 2 hours ago
                      </li>
                      <li class="list-group-item">
                        <i class="fa fa-upload fa-fw"></i> Uploaded a new file 4 hours ago
                      </li>
                      <li class="list-group-item">
                        <i class="fa fa-thumbs-up fa-fw"></i> Liked a post 6 hours ago
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    <i class="fa fa-briefcase fa-fw"></i>Constructor

                  </div>
                  <div class="panel-body">
                    <ul>
                      <li>Stack Developer Abdullah Zaka(CEO) at Source Code Company</li>
                      <li>Junior Developer Asad Rammy at  Source Code Company (2023-2024)</li>
                    </ul>
                  </div>
                </div>
              </div>
