...
<div class="content-wrapper">
	<div class="container-fluid">
		...
		<?php breadcrumb(); ?>
			...
			<form action="process_employee_shift_allocation_change.php">
			<div class="col-lg-12">
				<div class="form-group vAlign">
					<label><strong>Shift Name: </strong><select class="form-select" required name="shift_name">
									<?php populateDD("shift","shift_name","shift_name") ?>
								</select> </label>
					...
					<br>
					<br><input type="submit" formaction="reports/shift_allocation.php" value="View Allocation" formtarget="_new">
