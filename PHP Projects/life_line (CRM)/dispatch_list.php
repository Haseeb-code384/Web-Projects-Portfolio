...
<div class="breadcrumb h1"><i class="fa fa-list"></i>Dispatch List</div>
...
<th>Action</th>
						...
						<tbody>
							<?php
							$sqlview="SELECT id,date,dispatch.remarks,salesman,master_account.account,timestamp,entered_by FROM dispatch,master_account WHERE salesman=master_account.m_accountid ORDER BY id DESC";
							...
							<tr onClick="chnage_row_clr(this,'lightgreen');" onDblClick="chnage_row_wclr(this,'white');">
								...
								<td>
									<button>
									<a title="View Voucher" target="new" href="dispatch_voucher.php?dispatch_id=<?php echo $rowview[0];?>">View</button></a></button>
							<button>
