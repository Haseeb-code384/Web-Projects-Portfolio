...
<div class="table-responsive col-sm-12 table-sm" >
<table class="table table-fixed table-hover table-striped" style="padding: 0;"  id="employee_data">
...
<thead class="small bg-danger" style="position: sticky;top: 0;color: #fff;
  ...
  <tr style="background-color: black;color: white; height: 5px;" >
    <th colspan="20"><label style="height: 0px;">Highlighter Color</label>
