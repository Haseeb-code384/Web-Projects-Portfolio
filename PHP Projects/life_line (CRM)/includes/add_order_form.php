...
<div class="content-wrapper">
  ...
  <form method="post" action="process_order.php">
    ...
    <select name="status" class="form-select" required>
            <?php populateDDsel("order_status  order by sort","order_status","order_status","Under Process"); ?>
...
<div class="col-sm-6">
    ...
    <textarea type="text" name="customer_feedback" class="form-control" placeholder="Comments"></textarea>
        </div>
<div class="col-sm-6">
