...
<ul class="nav nav-tabs">
  ...
  $sqlpg = "SELECT DISTINCT category FROM `products` ORDER BY category ASC";
  ...
  <li class="nav-item "> <a class="nav-link  <?php if($currentpage==$this_page_name)
{
  ...
  <li class="nav-item "> <a class="nav-link text-danger" aria-current="page" href="view_deleted_products.php">Deleted Products</a> </li>
  <?php
