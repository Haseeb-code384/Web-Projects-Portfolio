...
if ( isset( $_REQUEST[ 'start_date' ] ) ) {
  ...
  $sqlview = "SELECT * from inquiry WHERE id IN (SELECT  inquiry_id FROM `inquiry_status_history` WHERE type='call' AND date(time) BETWEEN '$start_date' AND '$end_date' AND inquiry_id in (SELECT id FROM `inquiry` WHERE allocated_to='$login_user'))";
...
<div class="content-wrapper">
  <div class="container-fluid">
    <?php breadcrumb(); ?>
      <h3>Inquireies Called By <?php echo $login_user; ?> Between <?php echo $start_date; ?> & <?php echo $end_date; ?></h3>
    <div class="col-lg-12">
