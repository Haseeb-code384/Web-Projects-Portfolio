...
<div class="content-wrapper">
  ...
  <?php breadcrumb(); ?>
  <div class="row" style="">
  <form method="post" action="process_inquiry_admin.php">
    <div class="border col-lg-12"> <span style="color: red;">Note:</span> All RED Fields Are Must
      <div class="row">
        <div class="col-12 text-center h5" style="background-color: #7A382C;color: #F8C401;"> Contact Information Form</div>
      </div>
        
      <div class="row">
        <div class="col-sm-6">
          <label  class="text-danger"><strong>PHONE 1:</strong> </label>
          <input class="form-control" value="<?php echo $num; ?>" readonly  onKeyUp="get_network1(this.value);" type="text" name="phone1"   placeholder="Enter Phone 1"  required  id="phone1" maxlength="15">
        </div>
        <div class="col-sm-6">
          <label  class="text-danger"><strong>Phone 1 Network:</strong></label>
          <select name="phone1network"  required  id="phone1network" readonly  class="form-select">
      ...
      <div class="row">
        <div class="col-sm-6">
          ...
          <input class="form-control" value="<?php echo $num; ?>" type="text" name="whatsapp" placeholder="Enter Whatsapp Number" maxlength="15" id="whatsapp">
        </div>
        <div class="col-sm-6">
      ...
      <div class="row">
       ...
       <input type="text" name="patient_id"  maxlength="6"  class="form-control" > 
        </div>
            <div class="col-sm-6">
    ...
    <textarea name="other_information" class="form-control"></textarea>    
      ...
      <div class="row">
        <div class="col-12 text-center h5" style="background-color: #7A382C;color: #F8C401;"> Biological Information </div>
      </div>
      <div class="row">
        <div class="col-sm-6">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <select multiple required name="disease[]" id="disease" style="height: 300px;" title="Press CTRL To Select Multiple"  class="form-select">
...
<label class="btn btn-outline-danger col-12" for="<?php echo $rowsymp[0]; ?>"><?php echo $rowsymp[0]; ?></label>
        ...
        <select name="allocated_to" class="form-select text-center">
        <?php populateDDdistinct("email","user WHERE email IN (SELECT username FROM `user_networks` WHERE network IN (SELECT network FROM `network_series` WHERE series=SUBSTRING('$num', 1, 5)))") ?>
        </select>
