...
<div id="layoutSidenav_content" class="content-wrapper">
 ...
 counter("count1", 5000, , 5);
 counter("count2", 1000, , 5);
});
</script>
    ...
    <div class="row">
      <div class="col-xl-2 col-md-3">
        <div class="card bg-primary text-white mb-4">
          ...
          <div class="card-footer d-flex align-items-center justify-content-between">
            <h1 id="count1"> <?php echo showQuery("SELECT count(id) FROM `inquiry`"); ?> </h1>
      ...
      <div class="col-xl-2 col-md-3">
        <div class="card bg-danger text-white mb-4">
          ...
          <div class="card-footer d-flex align-items-center justify-content-between">
            <h1 id="count2"> <?php echo showQuery("SELECT count(*) FROM inquiry WHERE allocated_to='' GROUP BY allocated_to ORDER BY count(*) DESC"); ?> </h1>
