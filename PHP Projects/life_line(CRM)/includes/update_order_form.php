      ...
      <div class="border col-lg-12"> <span style="color: red;">Note:</span> All RED Fields Are Must
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <input type="text" name="tracking_id"  value="<?php echo $row_view['tracking_id']; ?>" class="form-control" >
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            <label class=""><strong>CUSTOMER FEEDBACK:</strong></label>
            <textarea type="text" name="customer_feedback" class="form-control" placeholder="Comments"><?php echo $row_view['customer_feedback']; ?></textarea>
          </div>
          <div class="col-sm-6">
