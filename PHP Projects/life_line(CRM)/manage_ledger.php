...
<body>
	...
	<div class="col-lg-12">
<div class="breadcrumb h1"><i class="fa fa-user"></i> Manage Ledger</div>
...
<form method="post">
	...
	<br>
	<input type="text" required name="name" class="form-group form-control" placeholder="Please Enter Ledger Name">
	...
	<br>
	<input type="text" name="num" class="form-group form-control" placeholder="Enter Employee Number"  required >
	</div>
		</div>
	<div class="row">
	
	<div class="form-group col-sm-6">
                                <label class="label_start">Select Account Head</label>
