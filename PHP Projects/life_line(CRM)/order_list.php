...
<div class="breadcrumb h1"><i class="fa fa-list"></i>Order List</div>
...
<th>Action</th>
						...
						<tbody>
							<?php
							$sqlview="SELECT date,order_by FROM `demand_order` GROUP BY date ORDER BY date DESC";
							...
							<tr onClick="chnage_row_clr(this,'lightgreen');" onDblClick="chnage_row_wclr(this,'white');">
								...
								<td>
									<button>
									<a title="View Order" target="new" href="saved_order.php?demand_date=<?php echo $rowview[0];?>">View</button></a></button>
<!--
							<button>
