...
$tdate = $_REQUEST[ 'date' ];
$remarks = ucwords( $_REQUEST[ 'remarks' ] );
$type = $_REQUEST[ 'type' ];
...
$invoice_no =$last_id;
header( "Location: view_dailyvoucher.php?id=" . $last_id );
?>
...
<div id="print_this">
  ...
  <div style="display: inline;"> ِ
    <table width="50%" border="1" style="position: absolute; float: left; margin-top: -18px">
      <tr>
        <th colspan="4"> Out Side Dr (بنام) </th>
      </tr>
      ...
      <?php
      executeQuery( "INSERT INTO `m_account_detail` (`sno`, `m_accountid`, `tr_date`, `amount`, `type`, `tr_description`, `invno`, `entered_by`, `edited_at`, `edited_by`, `info`) VALUES (NULL, $draccount[$i], '$tdate', '$dramount[$i]', '', '$drdesc[$i]', '$invoice_no', '$_SESSION[email]', '0000-00-00 00:00:00.000000', NULL, 'Dr')" );
    ...
    <table width="49.5%" border="1" style="float: right; margin-top: auto;">
      <tr>
        <th colspan="4"> In Side Cr (جمع) </th>
      </tr>
      <tr  style="background-color: lightgray;">
        <th>Cr Amount</th>
        <th>Description</th>
      ...
      <?php
      executeQuery( "INSERT INTO `m_account_detail` (`sno`, `m_accountid`, `tr_date`, `amount`, `type`, `tr_description`, `invno`, `entered_by`, `edited_at`, `edited_by`, `info`) VALUES (NULL, $craccount[$i], '$tdate', '$cramount[$i]', '', '$crdesc[$i]', '$invoice_no', '$_SESSION[email]', '0000-00-00 00:00:00.000000', NULL, 'Cr')" );
      }
