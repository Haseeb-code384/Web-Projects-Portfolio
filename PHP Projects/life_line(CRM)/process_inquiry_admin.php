...
//    echo $sname[$i];
   executeQuery("INSERT INTO `symptom_inquiry` (`id`, `inquiry_id`, `symptom_name`, `description`) VALUES (NULL, '$lastid', '$sname[$i]', '$key')");
    $i++;
        ...
        executeQuery("INSERT INTO `inquiry_status_history` (`id`, `inquiry_id`, `type`, `status`, `time`, `allocated_to`, `allocated_by`) VALUES (NULL, '$lastid','Inquiry Added','New Inquiry Added', '$currentDateTime','','$login_user')");
          
    executeQuery("INSERT INTO `inquiry_status_history` (`id`, `inquiry_id`, `type`, `status`, `time`, `allocated_to`, `allocated_by`) VALUES (NULL, '$lastid','Allocation','Inquiry Allocated', '$currentDateTime','$allocated_to','$login_user')");
	...
	if($query)
	{
alertredirect("Submitted Successfully","admin_add_inquiry.php");
	}
	else
	{
