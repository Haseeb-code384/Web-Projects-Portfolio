...
$ledgers="798,799,788,789,790,791,766,795,753,718,699,657,739,708,703,702,709";
$account_id = [798,799,788,789,790,791,766,795,753,718,699,657,739,708,703,702,709];
		...
		<td><?php $sum1=$sum1-$row[1]; echo $row[1]?></td>
			...
			else
			{
				echo "Cr";
                         ...
                         preg_match('/Receiving# (\d+)/', $row[3], $matches);
...
if (isset($matches[1])) {
  $lastNumber = $matches[1];
			...
			<td width="5%" style="border: none;">
                <button><a title="View Voucher" target="new" href="../view_dailyvoucher.php?id=<?php echo $row[4];?>">>></button></a>  
            ...
            if (stripos($row[3], "Automated Clearance Of Receiving#") !== false) {
                    
                    ?>
      <button><a title="View Voucher" target="new" href="../print_payment_receiving_bill.php?id=<?php echo $lastNumber; ?>">Details</button></a> 
            <?php }
