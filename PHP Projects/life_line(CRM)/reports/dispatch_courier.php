...
if ( isset( $_REQUEST[ 'submit_order' ] ) ) {
  ...
  executeQuery( "INSERT INTO `order_dispatch_cart`(`id`, `order_id`, `tracking_id`, `user`, `time`) (SELECT null,order_id,tracking_id,'$user','$currentDateTime' FROM order_dispatch_info WHERE order_id='$order_id' )" );
}
