      ...
      <?php include("fix_header.php"); ?>
          ...
          <tbody class="small">
            ...
            if ( isset( $_REQUEST[ 'cat' ] ) ) {
              $cat = $_REQUEST[ 'cat' ];
              $sqlview = "SELECT * FROM `expenses` where deleted =0 and expense_category='$cat'";
            } else {

              $sqlview = "SELECT * FROM `expenses` where deleted =0";
            }
            ...
            <tr  onClick="chnage_row_clr(this,'lightgreen');" onDblClick="chnage_row_wclr(this,'white');">
              ...
              <td><a href="edit_expense.php?id=<?php echo $rowview[0]; ?>">
                ...
                <button class="btn-sm btn-danger" title="Double Click To Delete" onDblClick="window.location.href='del.php?expense_id=<?php echo $rowview[0]; ?>'"><i class="fa fa-trash"></i></button></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
