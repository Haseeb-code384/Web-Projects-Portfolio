...
<?php 
			...
			<?php
                ...
                {
                   $sql3="SELECT m_accountid,account FROM `master_account` WHERE accounttype='$row2[0]' AND m_accountid IN(SELECT account_id FROM `m_account_permission` WHERE username='$_SESSION[email]' AND type='$account_filter')   order by account";  
                }
